            ...
            get
            {
                ...
                switch (propertyName)
                {
                    ...
                    case nameof(Password):
                        ...
                        regex = new Regex(@"(\w+\.)*\w+[A-Za-z]+");
                        if (!regex.IsMatch(password)) return "Пароль слишком простой, должны быть: цифры, спецсимволы, буквы в верхнем регистре, нижнем регистре и длинна более 6 символов";
                        return null;
                    default:
                        return null;
                }
